    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative w-full max-w-lg bg-surface-container rounded-2xl border border-outline-variant/15 shadow-2xl animate-slide-up">
        <div className="flex items-center justify-between px-6 py-4 border-b border-outline-variant/10">
          <h2 className="text-lg font-bold text-on-surface">일정 추가</h2>
        ...
        {success ? (
          <div className="p-8 text-center">
            ...
            <p className="font-bold text-on-surface">일정이 등록되었습니다!</p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={6}
                className="w-full bg-surface-container-highest border-none rounded-lg px-4 py-3 text-sm text-on-surface placeholder:text-outline focus:ring-1 focus:ring-primary/50 focus:outline-none resize-none overflow-y-auto max-h-[200px]"
              />
            </div>
